    ...
    <Transition appear show={isOpen} as={Fragment}>
      <Dialog as="div" className="relative z-50" onClose={disableEscapeClose ? () => {} : onClose}>
        ...
        <Transition.Child
          ...
          leaveTo="opacity-0"
        >
          <div className={`fixed inset-0 bg-black/50 ${overlayClass}`} onClick={closeOnOverlayClick ? onClose : null} />
        </Transition.Child>

        {/* Centered / Offset Modal */}
        <div
            ...
            >
              {(title || closeButton) && (
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200">
                  {title ? <Dialog.Title className="text-lg font-medium text-gray-900">{title}</Dialog.Title> : <div />}
